...
wget --quiet https://repo1.maven.org/maven2/io/trino/trino-server/367/trino-server-367.tar.gz &&\
mkdir -p /opt &&\
tar -xf trino-server-367.tar.gz -C /opt &&\
mv /opt/trino-server-367 /opt/trino &&\
